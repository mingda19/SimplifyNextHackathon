...
function RequestIntakePage() {
  ...
  if (isValidating) {
    return <div className="flex min-h-screen items-center justify-center bg-stone-50"><p className="text-xl animate-pulse text-stone-500">Loading...</p></div>
  }

  if (error) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-stone-50 p-4">
        <Card className="w-full max-w-md text-center shadow-sm border-stone-200">
          <CardHeader>
      ...
      <div className="flex min-h-screen items-center justify-center bg-stone-50 p-4">
        <Card className="w-full max-w-md text-center border-emerald-200 shadow-sm">
          <CardHeader className="space-y-4">
            ...
            <CardTitle className="text-2xl text-stone-800">Request Sent!</CardTitle>
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-3">
              <label htmlFor="feedback" className="text-lg font-medium text-stone-800 leading-tight block">
              ...
              <Textarea 
                ...
                className="min-h-[150px] text-lg p-4 bg-white resize-none"
                value={feedback}
